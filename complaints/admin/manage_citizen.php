...
if (isset($_POST['submit']))
{
    ...
    $query="insert into citizen(n_id,first_name,sec_name,third_name,last_name,city,address,mobile_number,gender) values('$n_id','$first_name','$sec_name','$third_name','$last_name','$city','$address','$mobile_number','$gender')";
